...
Arechiga \emph{et al.} \cite{arechiga2011acoustic} studied acoustic reconstruction of lightning channel geometry using microphone arrays, improved upon thunder localization by using compact acoustic arrays with 1k sample rate.
